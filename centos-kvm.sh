...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/nexne/centos/master/app/rpmforge.rpm
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/nexne/centos/master/app/screenfetch-dev
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/nexne/centos/master/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/nexne/centos/master/conf/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/nexne/centos/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/nexne/centos/master/conf/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/nexne/centos/master/conf/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
wget https://raw.githubusercontent.com/nexne/centos/master/app/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/nexne/centos/master/conf/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/nexne/centos/master/conf/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/nexne/centos/master/conf/bmon"
fi
...
wget -O bench "https://raw.githubusercontent.com/nexne/centos/master/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/pixelb/ps_mem/master/ps_mem.py"
wget -O userlogin "https://raw.githubusercontent.com/nexne/centos/master/user-login.sh"
wget -O userexpire "https://raw.githubusercontent.com/nexne/centos/master/autoexpire.sh"
wget -O usernew "https://raw.githubusercontent.com/nexne/centos/master/create-user.sh"
wget -O userdelete "https://raw.githubusercontent.com/nexne/centos/master/user-delete.sh"
wget -O userlimit "https://github.com/nexne/centos/raw/master/user-limit.sh"
wget -O renew "https://raw.githubusercontent.com/nexne/centos/master/user-renew.sh"
wget -O userlist "https://raw.githubusercontent.com/nexne/centos/master/user-list.sh" 
wget -O trial "https://raw.githubusercontent.com/nexne/centos/master/user-trial.sh"
...
wget -O checkvirus "https://github.com/nexne/centos/raw/master/checkvirus.sh"
#wget -O cron-autokill "https://raw.githubusercontent.com/nexne/centos/master/cron-autokill.sh"
wget -O cron-dropcheck "https://github.com/nexne/centos/raw/master/cron-dropcheck.sh"
